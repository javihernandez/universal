 ...
 * @param {Boolean} eof true if the end of section is the end of the file (rather then just before another section).
...
gpii.iniFile.readFile = function (path, options) {
    var content;
    try {
        content = fs.readFileSync(path, options.encoding || "utf-8");
    } catch (e) {
        content = "";
    }
