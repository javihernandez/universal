 ...
 * the application itself (which connects to the Online Flow Manager),
 * the browser,
...
It will be available in four language: English, German, Spanish and Greek.
...
Note, however, that most of the application-specific terms for the OLB cannot yet be mapped to common terms, since the corresponding common terms still need to be defined.

Acceptance tests are avaiable in [pull request 265](https://github.com/cstrobbe/universal/blob/patch-9/tests/acceptanceTests/AcceptanceTests_olb_web.js). 
